...
insert into Employ(employ_name,father_name, desig_id,depart_id,gender,dob,doj)
		values("Rajat singh",      "Veera singh",   2, 4, "m",  "1997/03/04",  "2016/04/08"),
			...
			("Shivam Yadav",  "Uday Yadav",    3, 1, "m",  "1991/04/01",  "2013/05/01"),
			("Leena Willium",   "Harry Watsom",  4, 1, "f",  "1996/01/09",  "2010/08/02"),
			("Jully oak",      "Alax oak",      3, 5, "f",  "1998/01/03",  "2020/08/01"),
			...
			("Anand Ram",      "Ram lal ",      3, 1, "m",  "1999/04/06",  "2013/08/02"),
			("Abhijeet singh ","Ram Singh",     1, 5, "m",   "1967/03/9",  "2001/08/19"),
			("Preeti Paal",    "Ajay Paal",     2, 5, "f",   "1983/3/23",  "1999/11/02"),
			("Ram Singh",      "Krishna Singh", 3, 2, "m",   "2002/04/08", "2021/12/09"),
			("Iyyaar",         "Hira lal",      3, 5, "m",   "1997/02/17", "2019/04/27"),
			("Lakhn singh",    "Sumit singh ",  1, 3, "m",   "2000/03/12", "2016/01/12"),
			("vishal Maurya",  "Anuj Maurya",   3, 1, "m",   "2002/08/23", "2019/02/27"),
