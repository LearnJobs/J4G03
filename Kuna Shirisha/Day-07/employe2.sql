 ...
 insert into department(depart_name, depart_abbr)	
  ...
  insert into Employ(employ_name, father_name,  desig_id, depart_id, gender, dob, doj)
		  values("Shirisha"       ,       "Anji"            ,  2 , 4,   "F",    "2000/03/21",   "2017/03/01"),
                        ("Manasa"         ,       "Ramesh"          ,  2 , 4,   "F",    "1996/05/22",   "2015/05/11"),
                        ("Renuka"         ,       "Sampath"         ,  2 , 4,   "F",    "2000/02/13",   "2020/10/31"),
                        ("Ankitha"        ,       "Ravi"            ,  2 , 4,   "F",    "1995/05/24",   "2019/09/25"),
                        ("Shruthi"        ,       "Laxman"          ,  2 , 4,   "F",    "1991/04/02",   "2016/01/22"),
                        ("Shailu"         ,       "Janardan"        ,  2 , 4,   "F",    "1992/09/03",   "2020/09/24"),
                        ("Thulasi"        ,       "Ram gopal"       ,  2 , 4,   "F",    "1993/08/30",   "2021/02/13"),
                        ("Anusha"         ,       "Ramu"            ,  2 , 4,   "F",    "1997/03/25",   "2015/09/19"),
                        ("Swetha"         ,       "Chiranjeevi"     ,  2 , 4,   "F",    "1998/09/31",   "2012/08/29"),
                        ("Janaki"         ,       "Kamal"           ,  2 , 4,   "F",    "1997/02/27",   "2011/07/04"),
                        ("Prasanna"       ,       "Charan"          ,  2 , 4,   "F",    "1993/06/28",   "2009/06/06"),
                        ("Kajal"          ,       "Venu"            ,  2 , 4,   "F",    "1998/07/20",   "2000/03/24"),
                        ("Prabhas"        ,       "Srinu"           ,  2 , 4,   "M",    "1994/01/19",   "2007/07/15"),
                        ("Mahesh"         ,       "Krishna"         ,  2 , 4,   "M",    "1992/03/18",   "2003/01/18"),
                        ("Vijay"          ,       "Gowtham"         ,  2 , 4,   "M",    "1991/07/01",   "2020/08/31"),
                        ("Anirudh"        ,       "Raj varma"       ,  2 , 4,   "M",    "1996/09/30",   "2022/04/25"),
                        ("Devi sri prasad",       "Darma sri prasad",  2 , 4,   "M",    "1997/08/24",   "2012/03/27"),
                        ("Shekar"         ,        "Kairm"          ,  2 , 4,   "M",    "1999/03/15",   "2002/07/30"),
                        ("Vaishnavi"      ,        "Anil"           ,  2 , 4,   "F",    "1998/06/13",   "2000/07/05"),
                        ("Kavitha"        ,        "Srikanth"       ,  2 , 4,   "M",    "1990/05/12",   "2021/08/07");
 ...
 insert into salary(employ_id, desig_id, bank_name,bank_ifsc ,bank_ac_no,salary)
		  Values(1,2,   "HDFC",   "HDFC0000518",     "5473268748732",    217321.23),
			...
			(2,3,   "ANDHRA", "ANDB000246",      "85372834325",      2384687.23),
			...
			(3,1,   "AND"  ,  "ANDB000246",      "8316487263874",    3274672.35),
			...
			(2,3,   "ADB",    "ANDB000246",      "86358762387487",   72837667.34),
			(2,5,   "KDCC",   "KDCC29836894",    "91224873288768",   4278943.767),
			(3,1,   "AND",    "ANDB000246",      "943254872638742",  3274672.35),
