...
public class Multiplication_Assignment2 {

	public Multiplication_Assignment2(int begining, int ending) {
		for(int i=1; i<=10; i++) {
	...
	public static void main(String[] args) {
		...
		System.out.print("enter Begining point: ");
		...
		if(start<end) {
			...
			while(temp_end<=end) {
				new Multiplication_Assignment2(start, temp_end);
				start+=5;
				temp_end+=5;
				System.out.println("\n");
			}
			...
			System.err.println("begining is always less");
		}
	}
}